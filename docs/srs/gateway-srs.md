...
*   **Sandbox-Bypass**: для сквозного тестирования сценариев Давида, карты с суффиксами `1111` и `4446` обязаны мгновенно признаваться валидными, пробивая контур без ошибок 422 [1.1].
